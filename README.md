...
| Scenario | Without Caching | With Incremental Caching |
|----------|----------------|--------------------------|
| 5 docs, first run | 30s | 30s |
| 5 docs, restart | 30s | **2s** ⚡ |
| 5 old + 2 new docs | 42s | **14s** ⚡ |
| 20 docs, restart | 120s | **2s** ⚡ |
...
<p align="center">
  Made with ❤️ by <a href="https://github.com/Hemanath06">Hemanath</a>
</p>